...
class Blockchain:
    def __init__(self):
        ...
        self.transaction = 0 # จำนวนเงิน for data
        # Genesis Block
    ...
    def create_block(self, nonce, previous_hash):
        ...
        block = {
            ...
            "nonce": nonce,
            "data": self.transaction, # ข้อมูลการทำธุรกรรม for data
...
def mining_block():
    amount = 1000000 # จำนวนเงินในการทำธุรกรรม for data
    blockchain.transaction = blockchain.transaction+amount # for data
    # PoW
