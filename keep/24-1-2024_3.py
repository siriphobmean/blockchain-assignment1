...
class Blockchain:
    def __init__(self):
        ...
        self.year = 2020
        # Genesis Block
        self.create_block(nonce=1, previous_hash="0", subject="วิศวกรรมคอมพิวเตอร์", score=138.5) # Genesis Block
       
    # สร้าง Block ขึ้นมาในระบบ Blockchain   
    def create_block(self, nonce, previous_hash, subject, score):
...
def mining_block():
    ...
    # Update Block ใหม่
    block = blockchain.create_block(nonce, previous_hash, subject, score)
    block["hash"] = blockchain.hash(block)
